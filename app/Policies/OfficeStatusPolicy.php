...
class OfficeStatusPolicy
{
     ...
     *
     * @param  \App\Models\User  $user
     * @param  \App\Models\OfficeStatus  $officeStatus
     * @return \Illuminate\Auth\Access\Response|bool
     */
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function restore(User $user, OfficeStatus $officeStatus)
    {
        //
    }
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function forceDelete(User $user, OfficeStatus $officeStatus)
    {
        //
    }
}
