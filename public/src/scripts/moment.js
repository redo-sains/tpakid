...
(function (global, factory) {
    ...
    var defaultLocaleMonths =
        "Januari_Februari_Maret_April_May_June_July_August_September_October_November_December".split(
            "_"
        );
    ...
    function firstWeekOffset(year, dow, doy) {
        var // first-week day -- which Januari is always in the first week (4 for iso, 1 for other)
            fwd = 7 + dow - doy,
