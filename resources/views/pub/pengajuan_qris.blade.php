...
<main id="main">
    ...
    <div class="breadcrumbs d-flex align-items-center" style="background-image: url('assets/img/blog-header.jpg');">
        <div class="container position-relative d-flex flex-column align-items-center">
            ...
            <h2>Pengajuan QRIS</h2>
            <ol>
                <li><a href="#">Akses Keuangan</a></li>
                <li><a href="#">QRIS</a></li>
                <li>Pengajuan QRIS</li>
            </ol>
            ...
            <div class="row gy-4 d-flex justify-content-end">
                <div class="col-lg-8" data-aos="fade-up" data-aos-delay="250">
                    ...
                    <form action="/pengajuan" method="post" role="form">
                        <br>
                        @csrf
                        <input type="hidden" name="jenis_pengajuan" value="QRIS">
                        <div class="row">
                        ...
                        <div class="row">
                            <div class="col-md-6 form-group">
                                ...
                                <input type="text" name="nama_usaha" value="{{ old('nama_usaha') }}"
                                    ...
                                    id="nama_usaha" placeholder="Masukan nama usaha"
                                    style="font-size: 14px;  border-radius: 0; height: 44px" 
                                     required  />
                            </div>
                            <div class="col-md-6 form-group mt-3 mt-md-0">
                        ...
                        <div class="row">
                            <div class="col-md-6 form-group">
                                ...
                                <input type="text" name="jenis_usaha" value="{{ old('jenis_usaha') }}"
                                    ...
                                    id="jenis_usaha" placeholder="Masukan jenis usaha"
                                    style="font-size: 14px;  border-radius: 0; height: 44px" 
                                     required  />
                            </div>
