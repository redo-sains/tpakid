            ...
            <div class="row gy-4 d-flex justify-content-end">
                <div class="col-lg-8" data-aos="fade-up" data-aos-delay="250">
                    ...
                    <form action="/pengajuan" method="post" role="form">
                        <br>
                        @csrf
                        <input type="hidden" name="jenis_pengajuan" value="SIMPEL">
                        <div class="row">
                        ...
                        <div class="row">
                            <div class="col-md-6 form-group">
                                ...
                                <input type="text" name="nama_sekolah" value="{{ old('nama_sekolah') }}"
                                    ...
                                    id="nama_sekolah" placeholder="Masukan nama sekolah"
                                    style="font-size: 14px;  border-radius: 0; height: 44px" 
                                     required  />
                            </div>
                            <div class="col-md-6 form-group mt-3 mt-md-0">
                        ...
                        <div class="row">
                            <div class="col-md-6 form-group">
                                ...
                                <input type="text" name="nama_guru" value="{{ old('nama_guru') }}"
                                    ...
                                    id="nama_guru" placeholder="Masukan Nama Guru"
                                    style="font-size: 14px;  border-radius: 0; height: 44px" 
                                     required  />
                            </div>
                            <div class="col-md-6 form-group mt-3 mt-md-0">
                                ...
                                <p> </p>
                                <input type="text" name="no_telpon_guru_pic" value="{{ old('no_telpon_guru_pic') }}"
                                    class="form-control  @error('no_telpon_guru_pic') is-invalid @enderror"
                                    id="no_telpon_guru_pic" required
                                    style="font-size: 14px;  border-radius: 0; height: 44px" />
                            </div>
                        </div>
                        <br>
